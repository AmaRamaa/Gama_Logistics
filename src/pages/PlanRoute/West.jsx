...
const West = () => {
    ...
    return (
        <div className="container d-flex flex-column align-items-center py-4 bg-light min-vh-100">
            ...
            <MapContainer center={[48.8566, 2.3522]} zoom={5} className="w-100" style={{ height: '500px', border: '2px solid #ccc', borderRadius: '10px', overflow: 'hidden', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)' }}>
                <TileLayer
